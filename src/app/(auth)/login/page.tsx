'use client';
/**
 * Login page — email/password and Google sign-in with redirect support.
 */
      ...
      >
        <div className="card p-8">
          ...
          <p className="text-sm mb-7" style={{ color: 'rgb(var(--text-secondary))' }}>
            Sign in to your Teacher&apos;s Pet account
          </p>
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'rgb(var(--text-secondary))' }}>
            ...
            <Link href="/signup" className="text-brand-400 font-medium hover:underline">Sign up free</Link>
          </p>
        </div>
      </motion.div>
    </div>
